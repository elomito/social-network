  ...
  return (
    <div className="flex h-full flex-col">
          ...
          return (
            <Link
              ...
              className={`group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all duration-200 ${
                isActive
                  ? 'bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700 shadow-sm shadow-blue-500/10'
      ...
      <div className="border-t border-gray-200/80 p-3">
        <Link
          href="/profile/me"
          className="flex items-center gap-3 rounded-xl px-3 py-2.5 transition-colors hover:bg-gray-100/80"
        >
